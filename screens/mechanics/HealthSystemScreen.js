...
function HealthSystemScreen({ navigation }) {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        ...
        <Text style={[styles.text]}>Health Depletion:</Text>
        ...
        <Text style={[styles.text]}>Zombie Damage:</Text>
        ...
        <Text style={[styles.text]}>Fall Damage:</Text>
        ...
        <Text style={[styles.text]}>Weapon Damage:</Text>
        ...
        <Text style={[styles.text]}>Splash Damage:</Text>
        ...
        <Text style={[styles.text]}>Drowning:</Text>
        ...
        <Text style={[styles.text]}>Negative Status Effects:</Text>
        ...
        <Text style={[styles.text]}>Health Restoration:</Text>
        ...
        <Text style={[styles.text]}>Increasing Max Health:</Text>
