...
function ElectricityScreen({ navigation }) {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Electricy Info</Text>

        <Text style={[styles.textHeader]}>Description:</Text>
        <Text style={[styles.text]}>Electricity allows one to use several new, powered items such as lights, sensors, electric doors and various traps.</Text>
        ...
        <Text style={[styles.text]}>Any 2 electrical devices can have at most 10 blocks between the 2 devices in order for them to be connectable using the Wire Tool.</Text>


        <Text style={[styles.textHeader]}>Circuits:</Text>
        ...
        <Text style={[styles.textHeader]}>Wattage:</Text>
        ...
        <Text style={[styles.textHeader]}>Relays:</Text>
        ...
        <Text style={[styles.text]}>Each relay consumes wattage from the circuit and must be considered when calculating the amount of wattage needed for the circuit.</Text>
        ...
        <Text style={[styles.textHeader]}>Switches:</Text>
        ...
        <Text style={[styles.text]}>Each switch has a wattage rating and, like relays must be included in calculating the wattage needed by the circuit.</Text>
      </ScrollView>
    );
  }
