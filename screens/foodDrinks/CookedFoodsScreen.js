...
function CookedFoodScreen({ navigation }) {
    return (
      <ScrollView>
        ...
        <Button title="Pumpkin Cheesecake" onPress={() => navigation.navigate('PumpkinCheesecake')} />
        ...
        <Button title="Fish Tacos" onPress={() => navigation.navigate('FishTocosItem')} />
        ...
        <Button title="Spaghetti" onPress={() => navigation.navigate('SpeghettiItem')} />
