...
function WeaponsScreen({ navigation }) {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        ...
        <TouchableOpacity style={[styles.button]} onPress={() => navigation.navigate('ClubsScreen')} >

          <Text style={[styles.buttonText]}>Clubs</Text>

        </TouchableOpacity>
        <TouchableOpacity style={[styles.button]} onPress={() => navigation.navigate('SledgehammersScreen')} >

          <Text style={[styles.buttonText]}>Sledgehammers</Text>

        </TouchableOpacity>
        <TouchableOpacity style={[styles.button]} onPress={() => navigation.navigate('SpearsScreen')} >

          <Text style={[styles.buttonText]}>Spears</Text>

        </TouchableOpacity>
        <TouchableOpacity style={[styles.button]} onPress={() => navigation.navigate('KnucklesScreen')} >

          <Text style={[styles.buttonText]}>Knuckles</Text>

        </TouchableOpacity>
        <TouchableOpacity style={[styles.button]} onPress={() => navigation.navigate('KnivesScreen')} >

          <Text style={[styles.buttonText]}>Knives</Text>

        </TouchableOpacity>
        <TouchableOpacity style={[styles.button]} onPress={() => navigation.navigate('BatonsScreen')} >

          <Text style={[styles.buttonText]}>Batons</Text>

        </TouchableOpacity>
        <TouchableOpacity style={[styles.button]} onPress={() => navigation.navigate('BowsScreen')} >

          <Text style={[styles.buttonText]}>Bows</Text>

        </TouchableOpacity>
        <TouchableOpacity style={[styles.button]} onPress={() => navigation.navigate('HandgunsSMGScreen')} >

          <Text style={[styles.buttonText]}>Handguns & SMG</Text>

        </TouchableOpacity>
        <TouchableOpacity style={[styles.button]} onPress={() => navigation.navigate('ShotgunsScreen')} >

          <Text style={[styles.buttonText]}>Shotguns</Text>


        </TouchableOpacity>
        <TouchableOpacity style={[styles.button]} onPress={() => navigation.navigate('MachineGunsScreen')} >

          <Text style={[styles.buttonText]}>Machine Guns</Text>

        </TouchableOpacity>
        <TouchableOpacity style={[styles.button]} onPress={() => navigation.navigate('RiflesScreen')} >

          <Text style={[styles.buttonText]}>Rifles</Text>

        </TouchableOpacity>
        <TouchableOpacity style={[styles.button]} onPress={() => navigation.navigate('RoboticTurretsScreen')} >

          <Text style={[styles.buttonText]}>Robotic Turrets</Text>

        </TouchableOpacity>
        <TouchableOpacity style={[styles.button]} onPress={() => navigation.navigate('ExplosivesScreen')} >

          <Text style={[styles.buttonText]}>Explosives</Text>

        </TouchableOpacity>

        <Text style={[styles.text]}>Strength Weapons:</Text>
        ...
        <Text style={[styles.text]}>Fortitude Weapons:</Text>
        ...
        <Text style={[styles.text]}>Agility Weapons:</Text>
        ...
        <Text style={[styles.text]}>Intelligence Weapons:</Text>
