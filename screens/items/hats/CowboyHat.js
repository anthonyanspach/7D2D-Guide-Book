...
function CowboyHatItem() {
    return (
      <View>
        <Text>Cow Boy Hat info</Text>
        
        <Text>Description:</Text>
        <Text>The Cowboy Hat is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Cowboy Hat has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
