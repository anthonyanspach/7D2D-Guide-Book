...
function CowboyHatItem() {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Cow Boy Hat info</Text>
        
        <Text style={[styles.text]}>Description:</Text>
        <Text style={[styles.text]}>The Cowboy Hat is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text style={[styles.text]}>The Cowboy Hat has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
        ...
        <Text style={[styles.list]}>Needle & Thread Vol.4</Text>
      </ScrollView>
    );
  }

export default CowboyHatItem;
