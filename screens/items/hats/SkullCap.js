...
function SkullCapItem() {
    return (
      <View>
        <Text>Skull cap info</Text>

        <Text>Description:</Text>
        <Text>The Press Boy Cap is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Skull Cap has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
