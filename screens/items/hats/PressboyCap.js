...
function PressboyCapItem() {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Press Boy cap info</Text>
        ...
        <Text style={[styles.text]}>The Press Boy Cap has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
...
export default PressboyCapItem;
