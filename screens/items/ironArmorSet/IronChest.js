...
function IronChestItem() {
    return (
      <View>
        <Text>Iron Chest Armor info</Text>

        <Text>Description:</Text>
        <Text>The Iron Chest Armor is an item of Clothing which can be crafted by the player and worn by their character as Armor to help protect them from physical damage.</Text>
