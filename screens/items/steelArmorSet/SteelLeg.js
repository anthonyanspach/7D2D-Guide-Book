...
function SteelLegItem() {
    return (
      <View>
        <Text>Steel Leg Armor info</Text>

        <Text>Description:</Text>
        <Text>The Steel Leg Armor is an item of Clothing which can be crafted by the player and worn by their character as Armor to help protect them from physical damage.</Text>
