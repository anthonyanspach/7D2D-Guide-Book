...
function SteelGlovesItem() {
    return (
      <View>
        <Text>Steel Gloves info</Text>

        <Text>Description:</Text>
        <Text>The Steel Gloves is an item of Clothing which can be crafted by the player and worn by their character as Armor to help protect them from physical damage.</Text>
