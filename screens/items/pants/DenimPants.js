...
function DenimPantsItem() {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Denim Pants info</Text>

        <Text style={[styles.textHeader]}>Description:</Text>
        <Text style={[styles.text]}>The Denim Pants is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text style={[styles.text]}>The Denim Pants has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
        ...
        <Text style={[styles.unlockList]}>Needle & Thread Vol.2</Text>
      </ScrollView>
    );
  }

export default DenimPantsItem;