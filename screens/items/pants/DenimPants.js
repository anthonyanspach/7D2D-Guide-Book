...
function DenimPantsItem() {
    return (
      <View>
        <Text>Denim Pants info</Text>

        <Text>Description:</Text>
        <Text>The Denim Pants is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Denim Pants has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
