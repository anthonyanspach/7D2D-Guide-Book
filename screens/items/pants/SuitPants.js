...
function SuitPantsItem() {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Suit Pants info</Text>

        <Text style={[styles.text]}>Description:</Text>
        <Text style={[styles.text]}>The Suit Pants is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance. They also offer 2.5% damage reduction if the player has read the Magnum Enforcer Vol.2 book.</Text>
        ...
        <Text style={[styles.text]}>The Suit Pants has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
