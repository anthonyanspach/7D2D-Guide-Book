...
function OverallsItem() {
    return (
      <View>
        <Text>Overalls info</Text>

        <Text>Description:</Text>
        <Text>The Overalls is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Overalls has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
