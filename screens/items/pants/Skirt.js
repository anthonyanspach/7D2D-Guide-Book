...
function SkirtItem() {
    return (
      <View>
        <Text>Skirt info</Text>

        <Text>Description:</Text>
        <Text>The Skirt is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Skirt has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
