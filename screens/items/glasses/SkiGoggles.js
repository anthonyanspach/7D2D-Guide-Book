...
function SkiGogglesItem() {
    return (
      <View>
        <Text>Ski Goggles info</Text>

        <Text>Description:</Text>
        <Text>"Ski Goggles pimp your look and boost your Agility." Ski Goggles are a type of Clothing that doesn't provide the player protection. Ski Goggles do, however, provide the player with one attribute point in Agility.</Text>
