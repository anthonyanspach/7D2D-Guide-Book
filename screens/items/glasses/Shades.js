...
function ShadesItem() {
    return (
      <View>
        <Text>Shades info</Text>

        <Text>Description:</Text>
        <Text>"Sunglasses make you look cool and also cool you down in hot weather." Shades are a type of Clothing that don't provide any protection from weather. They do, however, provide the player with one added attribute point in Perception.</Text>
