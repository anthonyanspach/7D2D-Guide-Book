...
function ShadesItem() {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Shades info</Text>

        <Text style={[styles.text]}>Description:</Text>
        <Text style={[styles.text]}>"Sunglasses make you look cool and also cool you down in hot weather." Shades are a type of Clothing that don't provide any protection from weather. They do, however, provide the player with one added attribute point in Perception.</Text>
