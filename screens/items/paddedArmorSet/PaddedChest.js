...
function PaddedChestItem() {
    return (
      <View>
        <Text>Padded Chest Armor info</Text>

        <Text>Description:</Text>
        <Text>The Padded Chest Armor is an item of Clothing which can be crafted by the player and worn by their character as Armor to help protect them from physical damage.</Text>
