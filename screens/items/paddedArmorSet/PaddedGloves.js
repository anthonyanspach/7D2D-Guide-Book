...
function PaddedGlovesItem() {
    return (
      <View>
        <Text>Padded Gloves info</Text>

        <Text>Description:</Text>
        <Text>The Padded Gloves is an item of Clothing which can be crafted by the player and worn by their character as Armor to help protect them from physical damage.</Text>
