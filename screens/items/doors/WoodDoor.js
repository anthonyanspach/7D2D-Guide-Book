...
function WoodDoorItem({ navigation }) {
    return (
      <ScrollView>
        ...
        <Text>Usage:</Text>
        <Text>A Wood Door offers three security feature options, in relation to the player's control of the Hatch. Holding down the 'E' key, while looking at the Reinforced Secure Wooden Door, will bring up the following three icons:</Text>
