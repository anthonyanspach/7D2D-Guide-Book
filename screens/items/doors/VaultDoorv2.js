...
function VaultDoorv2Item({ navigation }) {
    return (
      <View>
        <Text>Vault Door V2 Info</Text>

        <Text>Description:</Text>
        <Text>A Vault Door V2 is a craftable Door that has the ability to be locked by the player. It is the strongest door in the game craft-able by players.</Text>

        <Text>Usage:</Text>
        <Text>A Vault Door V2 offers three security feature options, in relation to the player's control of the Hatch. Holding down the 'E' key, while looking at the Reinforced Secure Wooden Door, will bring up the following three icons:</Text>
