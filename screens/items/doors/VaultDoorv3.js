...
function VaultDoorv3Item({ navigation }) {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Vault Door V3 Info</Text>

        <Text style={[styles.text]}>Description:</Text>
        <Text style={[styles.text]}>A Vault Door V3 is a craftable Door that has the ability to be locked by the player. It is the strongest door in the game craft-able by players.</Text>

        <Text style={[styles.text]}>Usage:</Text>
        <Text style={[styles.text]}>A Vault Door V3 offers three security feature options, in relation to the player's control of the Hatch. Holding down the 'E' key, while looking at the Reinforced Secure Wooden Door, will bring up the following three icons:</Text>
...
export default VaultDoorv3Item;
