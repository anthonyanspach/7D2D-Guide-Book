...
function VaultHatchv3Item({ navigation }) {
    return (
      <View>
        <Text>Vault Hatch V3</Text>

        <Text>Description:</Text>
        <Text>A Vault Hatch v3 is a hatch that has the ability to be locked by the player. It is upgraded from a Vault Hatch using Forged Steel.</Text>

        <Text>Usage:</Text>
        <Text>A Vault Hatch v3 offers three security feature options, in relation to the player's control of the Hatch. Holding down the 'E' key, while looking at the Reinforced Secure Wooden Door, will bring up the following three icons:</Text>
