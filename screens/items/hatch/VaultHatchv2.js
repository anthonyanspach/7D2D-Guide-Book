...
function VaultHatchv2Item({ navigation }) {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Vault Hatch V2</Text>

        <Text style={[styles.text]}>Description:</Text>
        <Text style={[styles.text]}>A Vault Hatch v2 is a hatch that has the ability to be locked by the player. It is upgraded from a Vault Hatch using Forged Steel. A Vault Hatch v2 can be upgraded to a Vault Hatch v3.</Text>

        <Text style={[styles.text]}>Usage:</Text>
        <Text style={[styles.text]}>A Vault Hatch v2 offers three security feature options, in relation to the player's control of the Hatch. Holding down the 'E' key, while looking at the Reinforced Secure Wooden Door, will bring up the following three icons:</Text>
...
export default VaultHatchv2Item;
