...
function SteelHatchItem({ navigation }) {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Steel Hatch Info</Text>

        <Text style={[styles.text]}>Description:</Text>
        <Text style={[styles.text]}>A Steel Hatch is a craftable hatch that has the ability to be locked by the player. It is crafted using Forged Steel, Springs, and Mechanical Parts.</Text>

        <Text style={[styles.text]}>Usage:</Text>
        <Text style={[styles.text]}>A Steel Hatch offers three security feature options, in relation to the player's control of the Hatch. Holding down the 'E' key, while looking at the Reinforced Secure Wooden Door, will bring up the following three icons:</Text>
