...
function IronHatchv2Item({ navigation }) {
    return (
      <View>
        <Text>Iron Hatch V2</Text>

        <Text>Description:</Text>
        <Text>A Iron Hatch V2 is a craft-able hatch that has the ability to be locked by the player. A Iron Hatch can be upgraded to a Vault Hatch.</Text>

        <Text>Usage:</Text>
        <Text>A Iron Hatch V2 offers three security feature options, in relation to the player's control of the Hatch. Holding down the 'E' key, while looking at the Reinforced Secure Wooden Door, will bring up the following three icons:</Text>
