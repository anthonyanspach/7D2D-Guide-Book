...
function IronHatchv2Item({ navigation }) {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Iron Hatch V2</Text>

        <Text style={[styles.text]}>Description:</Text>
        <Text style={[styles.text]}>A Iron Hatch V2 is a craft-able hatch that has the ability to be locked by the player. A Iron Hatch can be upgraded to a Vault Hatch.</Text>

        <Text style={[styles.text]}>Usage:</Text>
        <Text style={[styles.text]}>A Iron Hatch V2 offers three security feature options, in relation to the player's control of the Hatch. Holding down the 'E' key, while looking at the Reinforced Secure Wooden Door, will bring up the following three icons:</Text>
...
export default IronHatchv2Item;
