...
function PlantFiberPantsItem() {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Plant FIber Pants info</Text>

        <Text style={[styles.text]}>Description:</Text>
        <Text style={[styles.text]}>The Plant Fiber Pants is an item of Clothing which can be crafted by the player and worn by their character as Apparel, providing a small boost to Heat and Cold Resistance.</Text>
...
export default PlantFiberPantsItem;
