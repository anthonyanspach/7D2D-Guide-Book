...
function PlantFiberHoodItem() {
    return (
      <View>
        <Text>Plant Fiber Hood info</Text>

        <Text>Description:</Text>
        <Text>The Plant Fiber Hood is an item of Clothing which can be crafted by the player and worn by their character as Apparel, providing a small boost to Heat and Cold Resistance.</Text>
