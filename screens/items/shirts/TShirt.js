...
function TShirtItem() {
    return (
      <View>
        <Text>T-Shirt info</Text>

        <Text>Description:</Text>
        <Text>The T-Shirt is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The T-Shirt has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
