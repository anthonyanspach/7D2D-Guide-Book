...
function ShirtItem() {
    return (
      <View>
        <Text>Shirt info</Text>

        <Text>Description:</Text>
        <Text>The Shirt is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Shirt has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
