...
function BDUTopItem() {
    return (
      <View>
        <Text>BDU Top info</Text>

        <Text>Description:</Text>
        <Text>The BDU Top is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The BDU Top has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
        ...
        <Text>Needle & Thread Completed Collection</Text>
      </View>
    );
  }
