...
function HoodedSweatshirtItem() {
    return (
      <View>
        <Text>Hooded Sweatshirt info</Text>

        <Text>Description:</Text>
        <Text>The Hooded Sweatshirt is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Hooded Sweatshirt has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
