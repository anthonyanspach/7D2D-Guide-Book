...
function TankTopItem() {
    return (
      <View>
        <Text>Tank Top info</Text>

        <Text>Description:</Text>
        <Text>The Tank Top is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Tank Top has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
