...
function FlannelShirtItem() {
    return (
      <View>
        <Text>Flannel Shirt info</Text>

        <Text>Description:</Text>
        <Text>The Flannel Shirt is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Flannel Shirt has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
