...
function HazmatMaskItem() {
    return (
      <View>
        <Text>Hazmat Mask info</Text>

        <Text>Description:</Text>
        <Text>The Hazmat Mask is an item of Clothing which can not be crafted by the player and worn by their character as Apparel, providing a small boost to Heat and Cold Resistance.</Text>
