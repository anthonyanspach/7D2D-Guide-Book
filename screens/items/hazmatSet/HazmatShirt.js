...
function HazmatShirtItem() {
    return (
      <View>
        <Text>Hazmat Shirt info</Text>

        <Text>Description:</Text>
        <Text>The Hazmat Shirt is an item of Clothing which can not be crafted by the player and worn by their character as Apparel, providing a small boost to Heat and Cold Resistance.</Text>
