...
function LeatherPonchoItem() {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Leather Poncho info</Text>

        <Text style={[styles.text]}>Description:</Text>
        <Text style={[styles.text]}>The Leather Poncho is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text style={[styles.text]}>The Leather Poncho has one Cosmetic Slot for dyes and one Modifier Slot</Text>

        <Text style={[styles.list]}>Crafting:</Text>
        <Text style={[styles.list]}>20 Leather</Text>
      </ScrollView>
    );
  }
