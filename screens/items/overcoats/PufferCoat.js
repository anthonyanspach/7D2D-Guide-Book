...
function PufferCoatItem() {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Puffer Coat info</Text>

        <Text style={[styles.textHeader]}>Description:</Text>
        <Text style={[styles.text]}>The Puffer Coat is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text style={[styles.text]}>The Puffer Coat has one Cosmetic Slot for dyes and one Modifier Slot.</Text>

        <Text style={[styles.listHeader]}>Crafting:</Text>
        <Text style={[styles.list]}>50 Cloth Fragments</Text>
        <Text style={[styles.list]}>50 Feathers</Text>
        <Text style={[styles.list]}>35 Cotton</Text>
        <Text style={[styles.list]}>3 Sewing Kits</Text>

        <Text style={[styles.unlockListHeader]}>Unlock Options:</Text>
        <Text style={[styles.unlockList]}>Needle & Thread Vol.6</Text>
      </ScrollView>
    );
  }

export default PufferCoatItem;