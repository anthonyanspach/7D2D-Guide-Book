...
function PufferCoatItem() {
    return (
      <View>
        <Text>Puffer Coat info</Text>

        <Text>Description:</Text>
        <Text>The Puffer Coat is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Puffer Coat has one Cosmetic Slot for dyes and one Modifier Slot.</Text>

        <Text>Crafting:</Text>
        <Text>50 Cloth Fragments</Text>
        <Text>50 Feathers</Text>
        <Text>35 Cotton</Text>
        <Text>3 Sewing Kits</Text>

        <Text>Unlock Options:</Text>
        <Text>Needle & Thread Vol.6</Text>
      </View>
    );
  }
