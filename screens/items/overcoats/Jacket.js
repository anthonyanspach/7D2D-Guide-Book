...
function JacketItem() {
    return (
      <View>
        <Text>Jacket info</Text>

        <Text>Description:</Text>
        <Text>The Jacket is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Jacket has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
