...
function SuitJacketItem() {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Suit Jacket info</Text>

        <Text style={[styles.text]}>Description:</Text>
        <Text style={[styles.text]}>The Suit Jacket is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance. It also offers 2.5% damage reduction if the player has read the Magnum Enforcer Vol.2 book.</Text>
        ...
        <Text style={[styles.text]}>The Suit Jacket has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
