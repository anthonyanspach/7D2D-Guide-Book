...
function LeatherDusterItem() {
    return (
      <View>
        <Text>Leather Duster info</Text>

        <Text>Description:</Text>
        <Text>The Leather Duster is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Leather Duster has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
