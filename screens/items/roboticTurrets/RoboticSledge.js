...
function RoboticSledgeItem({ navigation }) {
    return (
      <View>
        <Text>Robotic Sledge Info</Text>

        <Text>Description:</Text>
        <Text>The Robotic Sledge is the simplest form of a turret that can be used automatically or manually for defense. The Robotic Sledge is only active when the owner moves within range of the turret.</Text>
