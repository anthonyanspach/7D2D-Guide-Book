...
function LeatherGlovesItem() {
    return (
      <View>
        <Text>Leather GLoves info</Text>

        <Text>Description:</Text>
        <Text>The Leather Gloves is an item of Clothing which can be crafted by the player and worn by their character as Armor to help protect them from physical damage.</Text>
