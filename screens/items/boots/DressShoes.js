...
function DressShoesItem() {
    return (
      <View>
        <Text>Dress Shoes info</Text>

        <Text>Description:</Text>
        <Text>The Dress Shoes is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Dress Shoes has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
