...
function WornBootsItem() {
    return (
      <View>
        <Text>Warn Boots info</Text>

        <Text>Description:</Text>
        <Text>The Worn Boots is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Worn Boots has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
