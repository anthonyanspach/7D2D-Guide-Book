...
function GothicBootsItem() {
    return (
      <View>
        <Text>Gothic Boots info</Text>

        <Text>Description:</Text>
        <Text>The Gothic Boots is an item of Clothing which can be worn by a character as Apparel, providing a boost to Heat and Cold Resistance.</Text>
        ...
        <Text>The Gothic Boots has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
