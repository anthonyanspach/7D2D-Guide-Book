...
function HighPerfRunShoesItem() {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>High Performance Running Shoes info</Text>

        <Text style={[styles.textHeader]}>Description:</Text>
        <Text style={[styles.text]}>The High-Performance Running Shoes is an item of Clothing which can be worn by a character as Apparel, providing a boost to both Heat and Cold Resistances as well as 20% boost to Stamina regeneration while running.</Text>
        ...
        <Text style={[styles.text]}>The High-Performance Running Shoes has one Cosmetic Slot for dyes and one Modifier Slot.</Text>
...
export default HighPerfRunShoesItem;