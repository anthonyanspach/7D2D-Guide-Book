...
function MilitaryGlovesItem() {
    return (
      <View>
        <Text>Military Gloves info</Text>

        <Text>Description:</Text>
        <Text>The Military Gloves is an item of Clothing which can be crafted by the player and worn by their character as Armor to help protect them from physical damage.</Text>
