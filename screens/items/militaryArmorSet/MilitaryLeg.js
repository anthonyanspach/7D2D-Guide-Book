...
function MilitaryLegItem() {
    return (
      <ScrollView style={[styles.scrollContainer]} contentContainerStyle={[styles.contentContainerStyle]}>
        <Text style={[styles.screenHeader]}>Military Leg Armor info</Text>

        <Text style={[styles.text]}>Description:</Text>
        <Text style={[styles.text]}>The Military Leg Armor is an item of Clothing which can be crafted by the player and worn by their character as Armor to help protect them from physical damage.</Text>
        ...
        <Text style={[styles.list]}>1 Military Armor Parts</Text>
        ...
        <Text style={[styles.list]}>2 Sewing Kits</Text>
...
export default MilitaryLegItem;
