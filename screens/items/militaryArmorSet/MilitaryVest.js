...
function MilitaryVestItem() {
    return (
      <View>
        <Text>Military Vest info</Text>

        <Text>Description:</Text>
        <Text>The Military Vest is an item of Clothing which can be crafted by the player and worn by their character as Armor to help protect them from physical damage.</Text>
