...
function MilitaryBootsItem() {
    return (
      <View>
        <Text>Military Boots info</Text>

        <Text>Description:</Text>
        <Text>The Military Boots is an item of Clothing which can be crafted by the player and worn by their character as Armor to help protect them from physical damage.</Text>
