...
function StartingGuide({ navigation }) {
    return (
      <ScrollView>
        <Text style={[styles.screenHeader]}>Starting Guide</Text>

        <Image
          source={require('../assets/7DAYS_LOGO_Stacked_black.png')}
          style={{
            height: 200,
            width: 400,
            alignSelf: 'center',
        ...
        <Text style={[styles.text]}>7 Days to Die is an open-world horde survival/crafting game with many ways to play it. Below you can find useful advice that an inexperienced player could follow. Depending on how you are with survival games this may or may not help you it is up to you!</Text>


        <Text style={[styles.sectionHeader]}>Terminology:</Text>
        <Text style={[styles.text]}>Zombies refers to all humanoid NPC enemies.</Text>

        <Text style={[styles.text]}>Specials can refer to all special enemies and hostile animals. These include the Spider Zombie, Bear, Zombie Bear, Zombie Dog, Feral Zombie, Screamer, Infected Police Officer, and Burn Victim.</Text>

        <Text style={[styles.text]}>Early Game is a loose term often used to refer to the time around when a player has just started in a world, it is also referred to as the 'Primitive Stage'.</Text>

        <Text style={[styles.text]}>Mid Game is a loose term to refer to the time around when a player has established a safe place to stay overnight, in addition to a good supply of resources and sufficient weaponry.</Text>

        <Text style={[styles.text]}>Late Game is a loose term to refer to the time around when a player is nearly fully self-sustained and can pretty much deal with any threat without much trouble.</Text>

        <Text style={[styles.text]}>End Game refers to when a player has a well-defended fortress and is completely self-sustained.</Text>

        <Image
          source={require('../assets/7Days_a19_burnt_01a.png')}
          style={{
            height: 200,
            width: 400,
            alignSelf: 'center',
        ...
        <Text style={[styles.sectionHeader]}>First Steps:</Text>
        <Text style={[styles.text]}>It is recommended to play the prefab map Navezgane for beginners. For beginners, anything higher than "Low" spawn settings is likely to be too overwhelming as large groups of zombies may spawn around a player in the open, causing the player to become trapped as the zombies tighten their circle.</Text>


        <Text style={[styles.sectionHeader]}>The First Day:</Text>
        ...
        <Text style={[styles.text]}>Sometimes you don't even need to finish off a zombie; stunning a zombie and sprinting away is also a viable strategy. As they say, discretion is the better part of valour.</Text>

        <Text style={[styles.text]}>Cloth Fragments can be crafted from Cotton Plants, which you can use to make cloth armour and clothing.</Text>

        <Text style={[styles.text]}>Plant Fibers (10x) are used to craft a Bedroll which will act as your respawn point if you die.</Text>
        ...
        <Text style={[styles.text]}>As you move around and gather basic supplies, do not forget to check rubbish and trash piles, abandoned cars, and backpacks that may be scattered around the area, these provide ample amounts of loot and supplies.</Text>
        ...
        <Text style={[styles.text]}>Keep in mind, however, that over the long term, prefabricated buildings offer much less protection than a player-built base. After the first couple of nights, you should begin building a base nearby to move into once complete.</Text>
        ...
        <Text style={[styles.text]}>If you are desperate, Pass n' Gas, double-story stores and anything with a rooftop area accessible via a ladder can be a godsend. Just remain crouched for the entirety of the night to avoid detection.</Text>

        <Text style={[styles.text]}>Clear out any Zombies in your Point of Interest while there is daylight because depending on the game settings Zombies will sprint at night time.</Text>

        <Image
          source={require('../assets/7Days_a19_interior_03a.png')}
          style={{
            height: 200,
            width: 400,
            alignSelf: 'center',
        ...
        <Text style={[styles.sectionHeader]}>The First Night:</Text>
        <Text style={[styles.text]}>22:00 is when dusk ends and night begins. It may be too late to leave a town or city if you are in one when this time hits. If so, simply try and find a nice hole to hide in and use chairs or Wood Frames to block entrances.</Text>
        ...
        <Text style={[styles.text]}>Even if a zombie begins to hunt you, do not panic and flee; simply fight it off using arrows or melee while crouched. Often if you can kill it quickly, you may not get detected by other zombies and can resume safely hiding until dawn.</Text>
        ...
        <Image
          source={require('../assets/7Days_a19_city_01a.png')}
          style={{
            height: 200,
            width: 400,
            alignSelf: 'center',
        ...
        <Text style={[styles.text]}>Now you can either choose a place to settle and start building a base, or you can become nomadic, roaming around scavenging and looting. Both options are fine. For more detailed information about both play styles check the following guides:</Text>
        ...
        <Image
          source={require('../assets/7Days_a19_interior_02a.png')}
          style={{
            height: 200,
            width: 400,
            alignSelf: 'center',
        ...
        <Text style={[styles.sectionHeader]}>Combat Tips:</Text>
        ...
        <Text style={[styles.text]}>Even a small group of zombies can kill an unwary player. Zombies' attacks can stun the player, and multiple zombies attacking at once can effectively "stun-lock" a survivor, making it very hard to fight back or escape.</Text>
        ...
        <Text style={[styles.text]}>When you know you cannot avoid a confrontation with a zombie and the Zombie is unaware of your presence</Text>

        <Text style={[styles.text]}>Your stone axe is not a weapon. Craft a Wooden Club, Stone Spear and/or a Primitive Bow A.S.A.P.</Text>
        ...
        <Image
          source={require('../assets/7Days_a19_western_01a.png')}
          style={{
            height: 200,
            width: 400,
            alignSelf: 'center',
        ...
        <Text style={[styles.sectionHeader]}>Firearms:</Text>
        ...
        <Text style={[styles.text]}>Shotguns are powerful short-range Weapon, however, they will not do as much damage should any of their Buckshot fail to hit the target. When using one, you will need to be sure of your headshot accuracy.</Text>

        <Text style={[styles.text]}>Sniper Rifles and Hunting Rifles are much more capable of effective long-range fire, delivering enough damage to even destroy blocks from a distance with only a few hits - and most zombies with a single well-placed bullet.</Text>
        ...
        <Text style={[styles.text]}>The table below shows the compatible ammunition for each weapon. The table below doesn't include the alternative ammunition for the primitive bow, crossbow, or shotgun. These ammunition types are later-game weapons but are powerful alternatives to rarer weapons and ammo.</Text>

        <Image
          source={require('../assets/7Days_a19_snow_01a.png')}
          style={{
            height: 200,
            width: 400,
            alignSelf: 'center',
        ...
        <Text style={[styles.sectionHeader]}>Melee Weapons:</Text>
        ...
        <Text style={[styles.text]}>An Auger and Chainsaw are amongst the most effective, provided you have the required Gas to operate one.</Text>

        <Text style={[styles.text]}>Many tools can also be used as melee weapons but they deal damage less effectively than purpose-built weapons.</Text>

        <Text style={[styles.text]}>Having a high entity damage value a Iron Sledgehammer is one of the most effective melee weapons available. Furthermore, it can deliver enough damage in one headshot to kill the majority of Zombies.</Text>

        <Text style={[styles.text]}>Combined with the use of the stealth system a Hunting Knife can be used extremely effectively when use to launch a sneak attack.</Text>
        ...
        <Text style={[styles.sectionHeader]}>Basic Building:</Text>
        <Text style={[styles.text]}>Nighttime is a nightmare. If you notice the clock coming up to 22:00 hours, it's time to find or build a safe place/shelter. Night time will last until anywhere from 4:00-10:00 hours, depending on how long a standard day/night cycle is set to.</Text>

        <Text style={[styles.text]}>Gather wood! The more the better. If you don't scavenge a Fireaxe early in the game, craft a Stone Axe. Its components are very easy to acquire from pretty much anywhere in Navezgane.</Text>
        ...
        <Text style={[styles.text]}>Gather rocks! These are collected as Small Stones or by mining large boulders. As soon as you have a small number, craft a Campfire. Keep a few small stones handy as they can be used to repair a Stone Axe.</Text>

        <Text style={[styles.text]}>If you find yourself close to a city or other buildings, search for one that is made of brick. Brick buildings are stronger and buy you more time.</Text>

        <Text style={[styles.text]}>Windows may look good, but they can be broken easily. Zombies can also see through a window to find a Survivor.</Text>
        ...
        <Text style={[styles.text]}>Try to start with a smaller base, larger bases require a staggering amount of time and resources to build. It is better to start small and then expand when needed. This will also give multiple layers of defence to fall back on when the hordes start knocking.</Text>

        <Text style={[styles.text]}>Leave some openings in your walls so that you can attack zombies. You can also build access to the rooftop to shoot zombies from above.</Text>

        <Text style={[styles.text]}>Blocks won't stack on fresh air, you need solid ground or surface to build on. If your buildings aren't well supported, they will most likely fall during a siege.</Text>

        <Text style={[styles.text]}>A way to keep zombies from reaching your shelter is to dig a moat or trench at least 3 blocks deep. This causes them to fall in, making them easy targets for a headshot. Traps can also be placed inside the trenches.</Text>

        <Text style={[styles.text]}>Surface bases are vulnerable to most attacks and require extensive defences. However, it is relatively easy to expand outwards and allows players to have a good sight radius.</Text>

        <Text style={[styles.text]}>Underground bases are extremely easy to defend but take a long time to build. They also require much more time when expanding. However, they are worth the effort, as players can remain virtually undetected inside underground bases.</Text>
        ...
        <Text style={[styles.text]}>It's a good idea to create a tunnel into your base from 10+ blocks outside of it. Provides a great way to run from hordes when you're surrounded. Most zombies will not try to enter via this if doors are used. A single block layer of earth will work well too.</Text>

        <Text style={[styles.text]}>Nighttime is a great time to sort your inventory and craft if there is no immediate danger.</Text>

        <Image
          source={require('../assets/7Days_a19_interior_01a.png')}
          style={{
            height: 200,
            width: 400,
            alignSelf: 'center',
        ...
        <Text style={[styles.sectionHeader]}>Surviving:</Text>
        <Text style={[styles.text]}>If any blocks in your shelter become damaged, repair them using a Stone Axe, Claw Hammer or Nailgun by holding the right mouse button (by default). This will consume relevant resources such as Wood for wood blocks, Cobblestone Rocks for cobble blocks, or reinforcing doors with Iron or Forged Iron.</Text>

        <Text style={[styles.text]}>Reinforce your walls with an appropriate repair tool. Starting from Frame blocks, the upgrade path is Wood → Cobblestone Rocks → Concrete Mix → Forged Steel</Text>

        <Text style={[styles.text]}>Try and keep at least one axe tool, pickaxe tool and knife as these come in handy all the time while scavenging during the day and can be useful last resort weapons.</Text>
        ...
        <Text style={[styles.text]}>Try to start a farm, it can be done indoors during the night if you build a greenhouse.</Text>
        ...
        <Text style={[styles.text]}>Listing some useful items you should keep on you; flashlight, night vision goggles, at least 1 stack of water, some clothes for each biome and a backup gun or knife etc. something you can use if you're out of ammo; bladed weapons do more damage but blunt weapons stun which is much better.</Text>
        ...
        <Text style={[styles.text]}>Only drink water straight from the source if you are dying of dehydration and do not have an empty jar to collect murky water to boil into safe water, as you are more than likely to get Dysentery, which can only be cured by Pure Mineral Water and Golden Rod Tea.</Text>

        <Text style={[styles.text]}>Bottled Murky Water can only be boiled on a Campfire, and no longer requires a Cooking Pot.</Text>

        <Text style={[styles.text]}>Some canned foods will also hydrate you, such as Chicken Soup.</Text>
        ...
        <Text style={[styles.text]}>Fresh food such as Blueberries and Corn grow in the wild and can be eaten for a very small boost in hunger. You can also cook these into other, more useful food items such as Corn Bread and Blueberry Pie which are healthy.</Text>
        ...
        <Text style={[styles.text]}>Food is essential. Keep an eye out for Stags, Does, Chickens, and Rabbits. Boars also but they will fight back. Then all you need to cook the meat is a Campfire and Combustible fuel to burn.</Text>

        <Text style={[styles.text]}>It is easiest to kill game early on with the easily crafted Primitive Bow. If you attack while undetected, you will gain a damage multiplier (just like with zombies) that should help take down animals faster.</Text>

        <Text style={[styles.text]}>It is possible to outrun chickens if not wearing any armour that decreases mobility. You can save on arrows by sprinting after them and hitting them with a club if you time it correctly and manage your stamina well. The same goes for rabbits, although they are more difficult.</Text>

        <Text style={[styles.text]}>The charred meat will deplete your Hydration level, so try have some Bottled Water handy.</Text>

        <Text style={[styles.text]}>Wild animals also suffer from the bleeding debuff like players do, you may only need to hit a deer with two arrows and just follow it until it dies of blood loss!</Text>

        <Text style={[styles.text]}>You will need a Cooking Pot to make the most advanced recipes, such as Goldenrod Tea and Meat Stew. You will likely find a Cooking Pot as loot before you gain the ability to craft one.</Text>

        <Text style={[styles.text]}>You will likely find a number of Eggs. If you are not starving, you should save these to make the highly nutritious Bacon and Eggs with a Cooking Grill.</Text>

        <Text style={[styles.text]}>It is not recommended to eat them raw, as they give little increase to fullness.</Text>

        <Text style={[styles.text]}>You can cook raw Eggs with Bottled Water at a Campfire that has a Cooking Pot to create a Boiled Egg.</Text>

        <Text style={[styles.text]}>You can save Old Sham Sandwiches to make into Antibiotics later on.</Text>

        <Text style={[styles.text]}>Try not eat any food that causes dysentery, including Raw Meat, Old Sham Sandwich, and Rotting Flesh. Try to find a better food source before fullness becomes a problem.</Text>

        <Text style={[styles.text]}>If you have something that heals dysentery, such as Golden Rod Tea, it is safe to eat Old Sham Sandwiches if you're in a pinch. Just be mindful of your health meter.</Text>

        <Text style={[styles.text]}>Be sure to check the kitchen area in houses as they often contain some food. Note that getting to them early on might be risky.</Text>

        <Text style={[styles.text]}>Refrigerators could contain Bottled Water and Meat Stew.</Text>

        <Text style={[styles.text]}>Canned food and Coffee is commonly found in cupboards.</Text>

        <Text style={[styles.text]}>Sinks often hold useful items such as Short Iron Pipes and Glass Jars, sometimes even a Wrench.</Text>

        <Text style={[styles.text]}>The Oven is known to be a good place to find a Cooking Pot, essential in the cooking of boiled food.</Text>

        <Text style={[styles.text]}>Growing crops is a multi-day plan (see Farming). If you intend to stay around in a specific area it might be a good plan to create a vegetable farm for crops such as corn, potatoes, coffee, etc.</Text>

        <Image
          source={require('../assets/7Days_a19_town_01a.png')}
          style={{
            height: 200,
            width: 400,
            alignSelf: 'center',
        ...
        <Text style={[styles.sectionHeader]}>Other Helpful Tips:</Text>
        <Text style={[styles.text]}>Don't waste your gun ammo too soon, there are other ways of killing zombies.</Text>

        <Text style={[styles.text]}>Always aim for a headshot with the pistol, but if you have a Shotgun, torso shots are just as effective and are easier to land while being further away than if you aimed at the head.</Text>

        <Text style={[styles.text]}>You can lure a group of Zombies to a car or Oil Barrel and shoot it, causing it to explode. This will kill any Zombies standing close by. However, in some cases, the ammo used to explode a car may be more than the ammo used to kill the Zombies.</Text>

        <Text style={[styles.text]}>Buildings tend to have Zombies inside; others can be found in the vicinity. The more urban the area, such as cities, the more Zombies. Use sneak to bypass them.</Text>

        <Text style={[styles.text]}>Don't enter a building if you spot several Zombies about outside!</Text>

        <Text style={[styles.text]}>If you can't lure zombies out easily, don't waste time trying. Search the surrounding area instead.</Text>

        <Text style={[styles.text]}>Take all you can find then run away as fast as you possibly can.</Text>

        <Text style={[styles.text]}>Prioritize certain resources over others that are already common to save inventory space.</Text>

        <Text style={[styles.text]}>Gun Safes, Desk Safes and Munitions Boxs are prized containers. Furthermore, they tend to contain the best loot in the game - Weapons.</Text>

        <Text style={[styles.text]}>Note that it is not important to have a large amount of the same weapon, what is important is the Ammunition it requires and Repair Kits to keep it in first-rate condition.</Text>

        <Text style={[styles.text]}>If you enter a light green area, it means you are exiting the Navezgane map and you will take damage if you continue in that direction; this is the Nuclear Fallout Zone. (Does not apply to Random World Generation.)</Text>

        <Text style={[styles.text]}>Don't waste too much space storing water, a stack of ten Bottled Water is more than enough for any outing.</Text>

        <Text style={[styles.text]}>Should you fail to find a gun, craft a Primitive Bow.</Text>


        <Text style={[styles.sectionHeader]}>Game Stages:</Text>

        <Image
          source={require('../assets/1280x720.webp')}
          style={{
            height: 200,
            width: 400,
            alignSelf: 'center',
        ...
        <Text style={[styles.sectionHeader]}>Early Game:</Text>
        ...
        <Text style={[styles.text]}>The Stone Axe is an all-purpose tool that can do practically everything: dig (dirt, sand and snow), mine (stone), chop (wood) or kill (enemies). Be sure to build this as soon as possible.</Text>
        ...
        <Text style={[styles.text]}>If need be, use Stone to seal off the entrance to a building (furniture can also be used in this aspect as well as frames, cobble blocks, etc.) to delay Zombies. They do not last long but they can hold Zombies off for long enough for you to run or do some scavenging.</Text>

        <Text style={[styles.text]}>Stamina is an important feature. Always try to keep it up. Stamina can be replenished quickly by drinking. Stamina is limited by your Fullness and Hydration meter.</Text>
        ...
        <Text style={[styles.text]}>Another way to get a house in the Early Game is to take over the house you spawn by repairing it up and you get a decent shelter it is quite useful for blood moons (if you don't wanna risk your base)</Text>

        <Text style={[styles.text]}>Keep an eye out for pallets covered in blue tarp or pallets with cement bags on them. In houses they are commonly found in basements and attics. Destroying them with a shovel gives you cobblestone rocks and cement respectively, which will be needed later on to upgrade blocks.</Text>


        <Text style={[styles.sectionHeader]}>Mid Game:</Text>
        ...
        <Text style={[styles.text]}>Keep a stack of Repair Kits handy, they are useful for repairing your tools when needed. Repairing a tool is much more cost-efficient than making a new one.</Text>

        <Text style={[styles.text]}>Once you get a Workbench, you can start crafting Ammunition. A Forge is required, as well as some amount of brass, lead, and gunpowder. Items that can be scrapped into brass and lead are fairly common loot. Shotgun Shells don't require brass, and are thus easier to craft.</Text>

        <Text style={[styles.text]}>If you find yourself running out of stamina very quickly, try brewing some Coffee. It gives a periodic energy boost which helps keep your Stamina full.</Text>

        <Text style={[styles.text]}>Consider making Corn and Potato farms so as to kick-start your Stew making.</Text>

        <Text style={[styles.text]}>If your mine entrance can be accessed directly from your base, be sure to place a secure Door to act as a checkpoint, so that others cannot enter your dwelling without permission should they dig into your mine.</Text>

        <Text style={[styles.text]}>Store shelves are a great way to get quick Iron. Each shelf is worth 4x Iron and breaks quickly depending on your Pickaxe level.</Text>
        ...
        <Text style={[styles.sectionHeader]}>Late Game:</Text>
        ...
        <Text style={[styles.text]}>Players at the later game stage have much more freedom in the game. Resources should be available.</Text>
      </ScrollView>
    );
  }
